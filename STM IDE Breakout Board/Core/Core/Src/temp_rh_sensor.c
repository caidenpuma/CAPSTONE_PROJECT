...
uint16_t temp_1_hr[6] = {0,0,0,0,0,0};	// stores last 6 (DEMO: 6 minutes) temperature readings in degrees F
uint16_t rh_1_hr[6] = {0,0,0,0,0,0};	// stores last 6 (DEMO: 6 minutes) humidity readings in %RH
