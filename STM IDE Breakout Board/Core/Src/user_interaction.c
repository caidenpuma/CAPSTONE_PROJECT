...
// Alerts:
uint16_t A_more_light    = 0; // UNUSED IN DEMO
uint16_t A_less_light    = 0; // UNUSED IN DEMO
...
uint16_t A_water         = 0;
uint16_t A_fertilize     = 0; // UNUSED IN DEMO
uint16_t A_dust          = 0; // UNUSED IN DEMO
uint16_t A_low_battery   = 0; // UNUSED IN DEMO
